<template>
  <div :class="['clb-loader-shapes', `clb-loader-shapes--${size}`]">
    <div class="clb-loader-shapes__shape clb-loader-shapes__shape--circle">
      <svg viewBox="0 0 80 80">
        <circle r="32" cy="40" cx="40" />
      </svg>
    </div>

    <div class="clb-loader-shapes__shape clb-loader-shapes__shape--triangle">
      <svg viewBox="0 0 86 80">
        <polygon points="43 8 79 72 7 72" />
      </svg>
    </div>

    <div class="clb-loader-shapes__shape clb-loader-shapes__shape--square">
      <svg viewBox="0 0 80 80">
...
import type { ClbLoaderShapesProperties } from '@/interfaces/components/loader.interface';
import { sizesExtra } from '@/consts/misc.consts';

const properties = withDefaults(defineProps<ClbLoaderShapesProperties>(), {
  size: 'md',
});

checkComponentPropertyValidity(properties.size, 'size', 'loader-shapes', true, sizesExtra);
</script>
...
.clb-loader-shapes {
  ...
  &__shape {
    ...
    &.clb-loader-shapes__shape--triangle {
      // width: 48px;
