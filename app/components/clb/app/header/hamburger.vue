<template>
  ...
  >
    <!-- eslint-disable -->
    <svg class="clb-app-header-hamburger__icon hamburger-icon" viewBox="0 0 100 100" width="60">
      <path
...
import type { ClbAppBarHamburgerProperties } from '@/interfaces/base/app.interface';

const properties = withDefaults(defineProps<ClbAppBarHamburgerProperties>(), {
  active: false,
