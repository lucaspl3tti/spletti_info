 ...
 * @since 4.0.0
 */
interface SplideMediaComponent extends SplideBaseComponent {
  /** @internal */
  reduce(reduced: boolean): void
  set(options: SplideOptions, base?: boolean, notify?: boolean): void
}
 ...
 * @since 3.0.0
 */
interface SplideDirectionComponent extends SplideBaseComponent {
  resolve(
    prop: string,
    axisOnly?: boolean,
    direction?: SplideOptions['direction']
  ): string
 ...
 * @since 3.0.0
 */
interface SplideElementCollection {
  root: HTMLElement
  track: HTMLElement
  list: HTMLElement
  slides: HTMLElement[]
 ...
 * @since 3.0.0
 */
interface SplideElementsComponent extends SplideBaseComponent, SplideElementCollection { }
 ...
 * @since 3.0.0
 */
interface SplideSlideComponent extends SplideBaseComponent {
  index: number
  slideIndex: number
  slide: HTMLElement
 ...
 * @since 3.0.0
 */
interface SplideLayoutComponent extends SplideBaseComponent {
  listSize(): number
 ...
 * @since 3.0.0
 */
interface SplideClonesComponent extends SplideBaseComponent { }
 ...
 * @since 3.0.0
 */
interface SplideMoveComponent extends SplideBaseComponent {
 ...
 * @since 3.0.0
 */
interface SplideControllerComponent extends SplideBaseComponent {
  go(
 ...
 * @since 3.0.0
 */
interface SplideArrowsComponent extends SplideBaseComponent {
  arrows: {
    prev?: HTMLButtonElement
    next?: HTMLButtonElement
  }
 ...
 * @since 3.0.0
 */
interface SplideAutoplayComponent extends SplideBaseComponent {
  play(): void
  pause(): void
  isPaused(): boolean
}
 ...
 * @since 3.0.0
 */
interface SplideCoverComponent extends SplideBaseComponent { }
 ...
 * @since 3.0.0
 */
interface SplideScrollComponent extends SplideBaseComponent {
  scroll(
    position: number,
    duration?: number,
    snap?: boolean,
 ...
 * @since 3.0.0
 */
interface SplideDragComponent extends SplideBaseComponent {
 ...
 * @since 3.0.0
 */
interface SplideKeyboardComponent extends SplideBaseComponent {
  disable(disabled: boolean): void
}
 ...
 * @since 3.0.0
 */
interface SplideLazyLoadComponent extends SplideBaseComponent {
  /** @internal */
  check(): void
}
 ...
 * @since 3.0.0
 */
interface SplidePaginationComponent extends SplideBaseComponent {
  items: SplidePaginationItem[]
  getAt(index: number): SplidePaginationItem
  update(): void
}
/**
 ...
 * @since 3.0.0
 */
interface SplidePaginationData {
 ...
 * @since 3.0.0
 */
interface SplidePaginationItem {
  li: HTMLLIElement
 ...
 * @since 3.0.0
 */
interface SplideSyncComponent extends SplideBaseComponent {
  remount(): void
}
 ...
 * @since 3.0.0
 */
interface SplideWheelComponent extends SplideBaseComponent { }
 ...
 * @since 4.0.0
 */
interface SplideLiveComponent extends SplideBaseComponent {
  disable(disabled: boolean): void
}
 ...
 * @since 3.0.0
 */
interface SplideOptions extends SplideResponsiveOptions {
  /**
   ...
   * ```
   */
  breakpoints?: Record<string | number, SplideResponsiveOptions>
  /**
   * Options used when the `(prefers-reduced-motion: reduce)` is detected.
   */
  reducedMotion?: SplideOptions
  /**
 ...
 * @since 3.0.0
 */
interface SplideResponsiveOptions {
  /**
   ...
   */
  paginationDirection?: SplideOptions['direction']
  /**
 ...
 * @since 3.0.0
 */
interface SplideTransitionComponent extends SplideBaseComponent {
...
interface SplideComponents {
  [key: string]: SplideBaseComponent | undefined
  Media: SplideMediaComponent
  Direction: SplideDirectionComponent
  Elements: SplideElementsComponent
  Slides: SplideSlidesComponent
  Layout: SplideLayoutComponent
  Clones: SplideClonesComponent
  Move: SplideMoveComponent
  Controller: SplideControllerComponent
  Arrows: SplideArrowsComponent
  Autoplay: SplideAutoplayComponent
  Cover: SplideCoverComponent
  Scroll: SplideScrollComponent
  Drag: SplideDragComponent
  Keyboard: SplideKeyboardComponent
  LazyLoad: SplideLazyLoadComponent
  Pagination: SplidePaginationComponent
  Sync: SplideSyncComponent
  Wheel: SplideWheelComponent
  Live: SplideLiveComponent
  Transition: SplideTransitionComponent
}
 ...
 * @since 3.0.0
 */
interface SplideEventMap {
  mounted: () => void
  ready: () => void
  click: (Slide: SplideSlideComponent, e: MouseEvent) => void
  move: (index: number, prev: number, dest: number) => void
  moved: (index: number, prev: number, dest: number) => void
  active: (Slide: SplideSlideComponent) => void
  inactive: (Slide: SplideSlideComponent) => void
  visible: (Slide: SplideSlideComponent) => void
  hidden: (Slide: SplideSlideComponent) => void
  refresh: () => void
  updated: (options: SplideOptions) => void
  resize: () => void
  resized: () => void
  drag: () => void
  dragging: () => void
  ...
  'pagination:mounted': (data: SplidePaginationData, item: SplidePaginationItem) => void
  'pagination:updated': (
    data: SplidePaginationData,
    prev: SplidePaginationItem,
    curr: SplidePaginationItem
  ) => void
  'navigation:mounted': (splides: SplideInstance[]) => void
  'autoplay:play': () => void
  'autoplay:playing': (rate: number) => void
  'autoplay:pause': () => void
  'lazyload:loaded': (img: HTMLImageElement, Slide: SplideSlideComponent) => void
}
 ...
 * @internal
 */
declare type Head<T extends any[]> = ((...args: T) => any) extends (
  arg: infer A,
  ...args: any[]
) => any
  ? A
 ...
 * @internal
 */
declare type Shift<T extends any[]> = ((...args: T) => any) extends (
  arg: any,
  ...args: infer A
) => any
  ? A
 ...
 * @since 3.0.0
 */
interface SplideSlidesComponent extends SplideBaseComponent {
  update(): void
  register(slide: HTMLElement, index: number, slideIndex: number): void
  get(excludeClones?: boolean): SplideSlideComponent[]
  getIn(page: number): SplideSlideComponent[]
  getAt(index: number): SplideSlideComponent | undefined
  ...
  filter(matcher: SlideMatcher): SplideSlideComponent[]
  style(prop: string, value: string | number, useContainer?: boolean): void
 ...
 * @since 3.0.0
 */
declare type SlidesIteratee = (
  Slide: SplideSlideComponent,
  index: number,
  Slides: SplideSlideComponent[]
) => void
/**
 ...
 * @since 3.0.0
 */
declare type SlidesPredicate = (
  Slide: SplideSlideComponent,
  index: number,
  Slides: SplideSlideComponent[]
) => any
/**
 * The type for filtering SplideSlideComponent objects.
 *
 * @since 3.0.0
 */
 ...
 * @since 3.0.0
 */
interface SplideEventBinderObject {
  bind(
    target: EventTargets,
 ...
 */
declare function EventBinder(): SplideEventBinderObject
 ...
 * @since 3.0.0
 */
interface SplideEventInterfaceObject extends SplideEventBinderObject {
  on<K extends keyof SplideEventMap>(event: K, callback: SplideEventMap[K]): void
  on(events: string | string[], callback: AnyFunction): void
  off<K extends keyof SplideEventMap>(events: K | K[] | string | string[]): void
  emit<K extends keyof SplideEventMap>(
    event: K,
    ...args: Parameters<SplideEventMap[K]>
  ): void
 ...
 */
declare function EventInterface(Splide?: SplideInstance): SplideEventInterfaceObject
 ...
 * @since 3.0.0
 */
interface SplideRequestIntervalInterface {
...
declare function RequestInterval(
  ...
  limit?: number
): SplideRequestIntervalInterface
 ...
 */
declare function State(initialState: number): SplideStateObject
 ...
 * @since 3.0.0
 */
interface SplideThrottleInstance<F extends AnyFunction> extends Function {
 ...
 */
declare function Throttle<F extends AnyFunction>(
  func: F,
  duration?: number
): SplideThrottleInstance<F>
 ...
 * @since 3.0.0
 */
declare class SplideInstance {
  /**
   * Changes the default options for all Splide instances.
   */
  static defaults: SplideOptions;
  /**
   ...
   */
  readonly event: SplideEventInterfaceObject;
  /**
   * The collection of all component objects.
   */
  readonly Components: SplideComponents;
  /**
   * The StateObject object.
   */
  readonly state: SplideStateObject;
  /**
   * An array with SyncTarget objects for splide instances to sync with.
   */
  readonly splides: SplideSyncTarget[];
  /**
   * The current options.
   */
  private readonly _o;
   ...
   */
  constructor(target: string | HTMLElement, options?: SplideOptions)
  /**
   ...
   * @return `this`
   */
  sync(splide: SplideInstance): this
  /**
   ...
   * @return `this`
   */
  on<K extends keyof SplideEventMap>(events: K, callback: SplideEventMap[K]): this
   ...
   * @return `this`
   */
  off<K extends keyof SplideEventMap>(events: K | K[] | string | string[]): this
  /**
   ...
   */
  add(
    slides: string | HTMLElement | Array<string | HTMLElement>,
    index?: number
  ): this
  /**
 ...
 * @since 3.0.0
 */
interface SplideRendererConfig {
  /**
   * The slider ID.
   */
  id?: string
...
declare class SplideRenderer {
   ...
   * @param splide - A Splide instance.
   */
  static clean(splide: SplideInstance): void
  /**
   ...
   */
  constructor(
    contents: string[] | SplideSlideContent[],
    options?: SplideOptions,
    config?: SplideRendererConfig,
    defaults?: SplideOptions
  )
  /**
   * Initializes the instance.
   */
 ...
 * @since 3.0.0
 */
declare const DEFAULTS: SplideOptions;
...
export type {
  AnyFunction,
  SplideArrowsComponent,
  SplideAutoplayComponent,
  SplideBaseComponent,
  CLASSES,
  CLASS_ACTIVE,
  CLASS_ARROW,
  ...
  CLASS_VISIBLE,
  Cast,
  SplideClonesComponent,
  ComponentConstructor,
  SplideComponents,
  SplideControllerComponent,
  SplideCoverComponent,
  DEFAULTS,
  SplideDirectionComponent,
  SplideDragComponent,
  EVENT_ACTIVE,
  ...
  EVENT_UPDATED,
  EVENT_VISIBLE,
  SplideElementsComponent,
  EventBinder,
  SplideEventBinderObject,
  EventInterface,
  SplideEventInterfaceObject,
  SplideEventMap,
  FADE,
  Head,
  SplideKeyboardComponent,
  LOOP,
  LTR,
  SplideLayoutComponent,
  SplideLazyLoadComponent,
  SplideLiveComponent,
  SplideMediaComponent,
  SplideMoveComponent,
  SplideOptions,
  SplidePaginationComponent,
  SplidePaginationData,
  ...
  SplideRequestIntervalInterface,
  Resolve,
  SplideResponsiveOptions,
  SLIDE,
  STATUS_CLASSES,
  SplideScrollComponent,
  Shift,
  ShiftN,
  SplideSlideComponent,
  SplideSlidesComponent,
  SplideRenderer,
  State,
  SplideStateObject,
  SplideSyncComponent,
  ...
  TTB,
  Throttle,
  SplideThrottleInstance,
  SplideTransitionComponent,
  SplideWheelComponent,
  SplideInstance,
};
/*
  eslint-enable
