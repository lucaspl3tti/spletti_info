                    ...
                    <div class="legal-disclosure">
                        ...
                        <div class="legal-disclosure-content">
                            ...
                            <div class="contact-info">
                                <h2>Kontakt</h2>
                                <p>
                                    E-Mail: <a class="hover-underline" href="mailto:jan-luca@spletti.info">jan-luca@spletti.info</a>
                                </p>
                            </div>

                            <div class="in-charge">
                                <h2>Redaktionell verantworttlich</h2>
                                <p>
                                    Jan-Luca Splettstößer<br/>
                                    Beethovenstraße 3<br/>
                                    46535 Dinslaken
                            ...
                            <p class="legal-disclosure-source">
                                Quelle:<br/>
                                <a class="hover-underline" href="https://www.e-recht24.de">https://www.e-recht24.de</a>
                            </p>
                        </div>
                    </div>
                </div>
