...
$data = [
    ...
    'skills-qualifications' => [
        ...
        'skills' => [
            ...
            'CSS/SCSS' => 'assets/img/icons/skills/css-3 Kopie.png',
            'HTML' => 'assets/img/icons/skills/html-5.png',
            ...
            'WordPress' => 'assets/img/icons/skills/typo3.png',
            'Typo3' => 'assets/img/icons/skills/wordpress.png',
    ...
    'about' => [
        ...
        'aboutMe' => 'Hi, ich heiße Jan-Luca (gerne auch nur Luca) und ich bin ein Junior Frontend Webdeveloper und UI Designer aus Deutschland. Ich habe über 3 Jahre an Erfahrung im entwickeln digitaler Produkte.',
        'interests' => '
        ...
        ',
        'firstProject' => 'Mein erstes Projekt war eine Pokemon Fanpage, auf welcher ich News und weiteren Inhalt rund um die Spiele veröffentlichen würde. Bei diesem Projekt konnte ich erste Erfahrungen mit HTML und CSS sammeln. Über die Jahre erweiterte ich mein Wissen und lernte neue Dinge, wie WordPress und PHP. In der Schule bekam ich außerdem die Chance, mein Wissen im IT-Kurs zu vertiefen.',
